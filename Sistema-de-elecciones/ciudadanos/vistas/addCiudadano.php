    ...
    <div id="page-content-wrapper" class="w-100 bg-light-blue">
      ...
      <nav class="navbar navbar-expand-lg navbar-light border-bottom border-dark" style="background-color:#3498DB;">
        ...
        <div class="container">
          ...
          <a style="background-color:#3498DB;" href="../../candidatos/vistas/addCandidato.php" class="list-group-item list-group-item-action text-light p-3 border-0"><i class="fas fa-male"></i> <strong> Candidatos</strong></a>
              ...
              <form method="POST" action="../servicios/add.php" enctype="multipart/form-data">
                <div class="form-row">
                  ...
                  <div class="form-group col-md-4">
                    <label for="cedula"><strong>No. Cedula</strong></label>
      ...
      <div class="col-xl-9 col-lg-12 ml-5 mt-3">
        <div class="table-responsive">
          <table class="table">
            <thead>
              <tr>
                <th colspan="col" style="font-size: 18px;"><small class="font-weight-bold">Ciudadanos<small></th>
                ...
                <th scope="col" style="font-size: 18px;"><small class="font-weight-bold">Correo<small></th>
