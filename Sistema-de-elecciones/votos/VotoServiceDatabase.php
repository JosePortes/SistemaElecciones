...
class VotoServiceDatabase
{
    ...
    public function ObtenerVotos($cedula)
    {
    ...
    public function ObtenerConteoVotos()
    {
    ...
    public function AgregarResultados($datos)
    {
