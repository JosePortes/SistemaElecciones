...
class PartidoServiceDataBase
{
    ...
    public function ListarPartido()
    {
        ...
        if ($result->num_rows !== 0) {
            ...
            while ($row = $result->fetch_object()) {
                ...
                $partido->StartData($row->idPartidos, $row->Nombre, $row->Descripcion, $row->Logo_Partido, $row->Estado);
    ...
    public function Agregar($partido)
    {
    ...
    //Actualizar puesto
    public function Actualizar($id, $partido)
    {
