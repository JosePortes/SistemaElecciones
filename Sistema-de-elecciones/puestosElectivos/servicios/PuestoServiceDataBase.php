...
class PuestoServiceDatabase
{
    ...
    public function ListarPuesto()
    {
        ...
        if ($result->num_rows !== 0) {
            ...
            while ($row = $result->fetch_object()) {
                ...
                $puestoElectivo->StartData($row->idPuesto_Electivo, $row->Nombre, $row->Descripcion, $row->Estado);
    ...
    public function Agregar($puestoElectivo)
    {
    ...
    //Actualizar puesto
    public function Actualizar($id, $puestoElectivo)
    {
