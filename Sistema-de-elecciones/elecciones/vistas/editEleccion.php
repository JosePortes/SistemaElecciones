...
<body>
  ...
  <div class="d-flex" id="content-wrapper">
    ...
    <div id="page-content-wrapper" class="w-100 bg-light-blue">
      ...
      <h4 class="font-weight-bold mb-0 text-light border-bottom border-light"><strong>Administracion Elecciones</strong></h4>
        <div class="container">
          ...
          <div class="card card-elec">
            ...
            <div class="card-body">
              <form method="POST" action="../servicios/edit.php?id=<?php echo $id; ?>">
                ...
                <button type="submit" class="btn btn-info">Actualizar Elecciones</button>
              </form>
            </div>
          </div>
        </div>
