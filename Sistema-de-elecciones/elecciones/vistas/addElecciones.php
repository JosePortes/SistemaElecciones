...
$lista = $service->ListarElecciones();
            ...
            <div class="card-body">
              <form method="POST" action="../servicios/add.php">
                ...
                <?php if ($lista[0]->Estado == 'Activo') : ?>
                  <button type="submit" class="btn btn-primary text-dark"><strong>Nuevas Elecciones</strong></button>
                <?php else : ?>
                  <button type="submit" class="btn btn-primary text-dark"><strong>Nuevas Elecciones</strong></button>
        ...
        <div class="col-xl-9 col-lg-12 ml-5 mt-3">
          <div class="table-responsive">
            <table class="table ">
              <thead>
                <tr>
                  <th colspan="col" style="font-size: 20px;"><small class="font-weight-bold">Elecciones Activas<small></th>


                  <th scope="col" style="font-size: 20px;"><small class="font-weight-bold">Fecha de Realizacion<small></th>
              ...
              <tbody>
                ...
                <?php foreach ($lista as $list) : ?>
                  <tr class="shadow-sm border border-primary rounded">
                    ...
                    <td class="align-middle"><a href="verElecciones.php?id=<?php echo $list->idElecciones; ?>" class="badge badge-dark text-white"> Ver reporte </a></td>
