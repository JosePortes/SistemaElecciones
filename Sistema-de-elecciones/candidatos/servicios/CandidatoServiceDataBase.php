...
class CandidatoServiceDatabase
{
    ...
    public function ListarCandidato()
    {
        ...
        if ($result->num_rows !== 0) {
            ...
            while ($row = $result->fetch_object()) {
                ...
                $candidato->StartData($row->idCandidatos, $row->Nombre, $row->Apellido, $row->Partido, $row->Puesto, $row->Foto, $row->Estado);
    ...
    public function Agregar($candidato)
    {
    ...
    public function Actualizar($id, $candidato)
    {
